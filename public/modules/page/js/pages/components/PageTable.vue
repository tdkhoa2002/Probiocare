<template>
  <div class="div">
    <div class="content-header">
      <h1>
        {{ type == "post" ? trans("pages.posts") : trans("pages.pages") }}
      </h1>
            ...
            <div class="sc-table">
              <div class="tool-bar el-row" style="padding-bottom: 20px">
                <div class="actions el-col el-col-8">
                  ...
                  <router-link :to="{ name: type == 'post' ? 'admin.page.post.create' : 'admin.page.page.create' }">
                    <el-button type="primary">
                      <i class="el-icon-edit"></i>
                      {{ type == "post" ? trans("pages.create post") : trans("pages.create page") }}
                    </el-button>
                  </router-link>
                </div>
                ...
                <el-table-column :label="trans('core.table.actions')" prop="actions">
                  <template slot-scope="scope">
                    <el-button-group>
                      <edit-button
                        v-if="type == 'page'"
                        :to="{ name: 'admin.page.page.edit', params: { pageId: scope.row.id } }"
                      ></edit-button>
                      <edit-button
                        v-if="type == 'post'"
                        :to="{ name: 'admin.page.post.edit', params: { pageId: scope.row.id } }"
                      ></edit-button>
...
export default {
  ...
  methods: {
    queryServer(customProperties) {
      ...
      axios
        .get(
          route("api.page.page.indexServerSide", {
            ...properties,
            ...customProperties,
          })
        )
