...
use Modules\Menu\Presenters\MainMenuPresenter;
use Modules\Menu\Presenters\FooterMenuPresenter;
...
return [
    ...
    */
    ...
    'styles' => [
        'main_menu'  =>  MainMenuPresenter::class,
        'footer_menu'  =>  FooterMenuPresenter::class,
    ]
];
