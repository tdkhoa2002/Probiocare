...
use Cache;
use Config;
use Modules\Core\Html\ThemeHtmlBuilder;
use Modules\Core\Theme\Loader;
use Modules\Core\Theme\Stylist;
...
class StylistServiceProvider extends AggregateServiceProvider
{
    ...
    private function registerAliases()
    {
        ...
        $aliasLoader->alias('Stylist', 'Modules\Core\Facades\StylistFacade');
        $aliasLoader->alias('Theme', 'Modules\Core\Facades\ThemeFacade');

        $this->app->alias('stylist', 'Modules\Core\Theme\Stylist');
    }
    ...
    {
        $this->commands(
            'Modules\Core\Console\PublishAssetsCommand'
        );
    }
