$(document).ready(function () {
	...
	if (typeof window.includeMediaSingle === 'undefined') {
		window.includeMediaSingle = function (mediaId, filePath, mediaType, mimetype, zoneWrapper) {
			...
			var html = '<figure data-id="' + mediaId + '">' + mediaPlaceholder +
				...
				'</figure>';
			zoneWrapper.append(html).fadeIn('slow', function () {
				toggleButton($(this));
			});
			zoneWrapper.children('input').val(mediaId);
		};
	}
