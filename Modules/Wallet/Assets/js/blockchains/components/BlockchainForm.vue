            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  >
                    <el-input-number v-model="blockchain.chainid" :min="0"></el-input-number>
                    <div
                ...
                <div class="col-md-6">
                  <el-form-item
                    :label="trans('blockchains.form.wallet_receive')"
                    :class="{
                      'el-form-item is-error': form.errors.has('wallet_receive'),
                    }"
                  >
                    <el-input v-model="blockchain.wallet_receive"></el-input>
                    <div
                      v-if="form.errors.has('wallet_receive')"
                      class="el-form-item__error"
                      v-text="form.errors.first('wallet_receive')"
                    ></div>
                  </el-form-item>
                </div>
              </div>
