                ...
                <div class="col-md-4">
                  ...
                  >
                    <el-select
                      ...
                      placeholder="Select"
                    >
                      <el-option key="CRYPTO" label="CRYPTO" value="CRYPTO"></el-option>
                      <el-option key="FIAT" label="FIAT" value="FIAT"></el-option>
                    </el-select>
                    <div
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <el-form-item
                    ...
                    :class="{
                      'el-form-item is-error': form.errors.has('transfer_fee'),
                    }"
                  >
                    <el-input-number
              ...
              <div class="row">
                <div class="col-md-4">
                  <el-form-item
                    ...
                    :class="{
                      'el-form-item is-error': form.errors.has('swap_enable'),
                    }"
                  >
                    <el-select
                ...
                <div class="col-md-4">
                  <el-form-item
                    ...
                    :class="{
                      'el-form-item is-error': form.errors.has('swap_fee_type'),
                    }"
                  >
                    <el-select
...
export default {
  ...
  mixins: [ShortcutHelper, ActiveEditor, SingleFileSelector],
  props: {
    locales: {
      default: null,
      type: Object,
  ...
  methods: {
    ...
    getRoute() {
      return route("api.wallet.currency.store");
    },
  },
};
</script>