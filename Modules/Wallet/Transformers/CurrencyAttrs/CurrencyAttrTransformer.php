...
class CurrencyAttrTransformer extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'nativeToken'=>$this->resource->nativeToken,
            ...
            'value_need_approve_currency_title' => $this->resource->valueNeedApproveCurrency->title ?? "",
            ...
            'max_amount_withdraw_daily_currency_title' => $this->resource->maxAmountWithdrawDailyCurrency->title??"",
