            ...
            <div class="box-body">
              <el-tabs v-model="activeTab">
                ...
                >
                  ...
                  >
                    <el-switch v-model="page[locale].status" active-color="#13ce66" inactive-color="#ff4949"> </el-switch>
                    <div
...
export default {
  components: { FormErrors, SingleMedia, TagsInput, Treeselect },
  ...
  methods: {
    ...
    fetchTemplates() {
      axios.get(route("api.page.page-templates.index", ["page"])).then((response) => {
    ...
    fetchPage() {
      this.loading = true;
      axios.post(route("api.page.page.find", { page: this.$route.params.pageId })).then((response) => {
        this.loading = false;
