...
class PageServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app['events']->listen(LoadingBackendTranslations::class, function (LoadingBackendTranslations $event) {
            ...
            $event->load('posts', Arr::dot(trans('page::posts')));
        });
    ...
    private function registerBindings()
    {
        ...
        $this->app->bind(
            'Modules\Page\Repositories\CategoryRepository',
            function () {
                $repository = new \Modules\Page\Repositories\Eloquent\EloquentCategoryRepository(new \Modules\Page\Entities\Category());

                if (!config('app.cache')) {
                    return $repository;
                }

                return new \Modules\Page\Repositories\Cache\CacheCategoryDecorator($repository);
            }
        );
