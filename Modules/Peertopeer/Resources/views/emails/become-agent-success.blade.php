...
@section('title')
Welcome to {{setting('core::site-name')}}!
@stop
@section('customerID')
{{$customer_id}}
@stop
                                    ...
                                    <tr>
                                        <td class="pad">
                                            <div
                                                ...
                                                <p style="margin: 0;">
                                                    Hi {{$customer_name}},
                                                    <br /><br />Now you are our P2P Agent can start to create Buy/Sell Ads on our platform! <br /><br />
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td class="pad">
                                            <div align="center" class="alignment">
                                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="/#" style="height:38px;width:80px;v-text-anchor:middle;" arcsize="11%" stroke="false" fillcolor="#0068a5"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:14px"><![endif]--><a
                                                    href="{{route('fe.p2p.market.agents')}}"
                                                    style="text-decoration:none;display:inline-block;color:#fff;background-color:#0068a5;border-radius:4px;width:auto;border-top:0px solid transparent;font-weight:400;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:5px;padding-bottom:5px;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:14px;text-align:center;mso-border-alt:none;word-break:keep-all;"
                                                    target="_blank"><span
                                                        style="padding-left:20px;padding-right:20px;font-size:30px;display:inline-block;letter-spacing:5px;"><span
                                                            style="word-break: break-word; line-height: 40px;"></span>Create Ads Now!</span></a>
