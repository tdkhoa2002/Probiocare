...
class JobCompletedOrderBuy implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            $wallet = app(WalletRepository::class)->findByAttributes(['customer_id' => $order->customer_id, 'currency_id' => $order->asset_currency_id]);
            if ($wallet) {
            ...
            $transaction = [
                ...
                'currency_id' => $order->asset_currency_id,
                'blockchain_id' => null,
                'action' => TypeTransactionActionEnum::USER_BUY_ADS,
