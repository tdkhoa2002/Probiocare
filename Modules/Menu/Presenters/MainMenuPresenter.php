...
class MainMenuPresenter extends Presenter
{
    ...
    {
        return PHP_EOL . '<ul class="navbar-nav my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100%">' . PHP_EOL;
    }
    ...
    public function getMenuWithoutDropdownWrapper($item)
    {
        ...
        return '<li class="nav-item"><a class="nav-link ' . $this->getActiveState($item) . '" aria-current="page" href="' . $item->getUrl() . '" ' . $item->getAttributes() . '>' . $item->getIcon() . ' ' . $item->title . '</a></li>' . PHP_EOL;
    }
