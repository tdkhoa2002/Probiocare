...
use Modules\Menu\Facades\Menu as MenuFacade;
use Modules\Menu\MenuBuilder as Builder;
use Modules\Menu\MenuItem as PingpongMenuItem;
use Illuminate\Foundation\AliasLoader;
use Modules\Menu\Menu as MenuMenu;
...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('menus', function ($app) {
            return new MenuMenu($app['view'], $app['config']);
        });
    }
    ...
    protected function registerBladeTags()
    {
        ...
        $this->app['blade.compiler']->directive('menuTitle', function ($arguments) {
            return "<?php echo MenuDirective::getTitle($arguments); ?>";
        });
    }
}
