  ...
  <div class="div">
    <div class="content-header">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ name: 'admin.loyalty.order.index' }">
          {{ trans("orders.list resource") }}
        </el-breadcrumb-item>
        <el-breadcrumb-item :to="{ name: 'admin.loyalty.order.create' }">
          {{ trans(`orders.title.${orderTitle}`) }}
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
export default {
  ...
  methods: {
    fetchOrder() {
      ...
      axios
        .get(
          route("api.loyalty.order.detail", {
    ...
    fetchTransaction() {
      axios
        .get(
          route("api.loyalty.order.transaction", {
