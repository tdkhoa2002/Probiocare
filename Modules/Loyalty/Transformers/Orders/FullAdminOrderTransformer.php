...
namespace Modules\Loyalty\Transformers\Orders;

use Carbon\Carbon;
use Illuminate\Http\Resources\Json\JsonResource;
use Mcamara\LaravelLocalization\Facades\LaravelLocalization;
use Modules\Customer\Transformers\Customers\SmallCustomerTransformer;
use Modules\Loyalty\Transformers\PackageTerms\PackageTermTransformer;
use Modules\Wallet\Transformers\Currencies\SmallCurrencyTransformer;

class FullAdminOrderTransformer extends JsonResource
{
