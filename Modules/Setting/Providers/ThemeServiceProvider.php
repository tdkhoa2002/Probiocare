...
class ThemeServiceProvider extends ServiceProvider
{
    ...
    private function setActiveTheme()
    {
        ...
        $themeName = $this->app['setting.settings']->get('core::template', null, 'Cryperr');
    ...
    {
        $directories = $this->app['files']->directories(config('asgard.core.config.themes.paths', [base_path('/Themes')])[0]);
