<template>
  <div class="div">
      ...
      <div class="row">
            ...
            <div class="box-body">
              <el-tabs v-model="activeTab">
                ...
                >
                  ...
                  >
                  <el-form-item
                    :label="trans('products.form.title')"
                    :class="{
                  ...
                  <el-form-item
                    :label="trans('products.form.slug')"
                    :class="{
                      'el-form-item is-error': form.errors.has(
                        locale + '.slug'
                      ),
                  ...
                  <el-form-item
                    :label="trans('products.form.sumary')"
                    :class="{
                      'el-form-item is-error': form.errors.has(
                        locale + '.sumary'
                      ),
                  ...
                  <el-form-item
                    :label="trans('products.form.product_info')"
                    :class="{
                      'el-form-item is-error': form.errors.has(
                        locale + '.product_info'
                      ),
                  ...
                  >
                    <component
                      :is="getCurrentEditor()"
                      v-model="product[locale].product_info"
                      :value="product[locale].product_info"
                    ></component>
                    <div
                      v-if="form.errors.has(locale + '.product_info')"
                      class="el-form-item__error"
                      v-text="form.errors.first(locale + '.product_info')"
                    ></div>
                  </el-form-item>
                    ...
                    >
                      <div class="box-body">
                        <el-form-item :label="trans('core.form.meta_title')">
                          <el-input
                            v-model="product[locale].meta_title"
                          ></el-input>
                        </el-form-item>
                        <el-form-item
                        ...
                        >
                          <el-input
                            v-model="product[locale].meta_description"
                            type="textarea"
                            autosize
                            maxlength="186"
                            :rows="4"
                    ...
                    >
                      <div class="box-body">
                        <el-form-item :label="trans('core.form.og_title')">
                          <el-input
                            v-model="product[locale].og_title"
                          ></el-input>
                        </el-form-item>
                        <el-form-item
                          :label="trans('core.form.og_description')"
                        >
                          <el-input
                            v-model="product[locale].og_description"
                            type="textarea"
                            autosize
                            :rows="4"
                            maxlength="186"
                        ...
                        <el-form-item :label="trans('core.form.og_type')">
                          <el-select
                            v-model="product[locale].og_type"
        ...
        <div class="col-md-3">
          <div class="box box-primary">
            <div class="box-body">
              <el-form-item
                :label="trans('products.form.code')"
                :class="{
              ...
              <el-form-item
                :label="trans('products.form.category')"
                :class="{
              ...
              <el-form-item
                :label="trans('products.form.product_status')"
                :class="{
              ...
              >
                ...
                <div
                  v-if="form.errors.has('product_status')"
                  class="el-form-item__error"
                  v-text="form.errors.first('product_status')"
                ></div>
              </el-form-item>
              <el-form-item
                :label="trans('products.form.price')"
                :class="{
              ...
              <el-form-item
                :label="trans('products.form.price_sale')"
                :class="{
              ...
              >
                ...
                ></el-input-number>
                <div
                  v-if="form.errors.has('price_sale')"
                  class="el-form-item__error"
                  v-text="form.errors.first('price_sale')"
                ></div>
              </el-form-item>
              <el-form-item
                :label="trans('products.form.status')"
                :class="{
              ...
              <el-form-item
                :label="trans('products.form.show_homepage')"
                :class="{
                  'el-form-item is-error': form.errors.has('show_homepage'),
                }"
              >
                <el-switch
                  v-model="product.show_homepage"
                  active-color="#13ce66"
                  inactive-color="#ff4949"
                >
                </el-switch>
              ...
              <el-form-item
                :label="trans('products.form.is_best_selling')"
                :class="{
              ...
              >
                ...
                <div
                  v-if="form.errors.has('is_best_selling')"
                  class="el-form-item__error"
                  v-text="form.errors.first('is_best_selling')"
                ></div>
              </el-form-item>
              <el-form-item
                :label="trans('products.form.is_promotion')"
                :class="{
              ...
              >
                ...
                <div
                  v-if="form.errors.has('is_promotion')"
                  class="el-form-item__error"
                  v-text="form.errors.first('is_promotion')"
                ></div>
              </el-form-item>
              <el-form-item
                :label="trans('products.form.is_new_arrivals')"
                :class="{
                  'el-form-item is-error': form.errors.has('is_new_arrivals'),
                }"
              >
                <el-switch
                  v-model="product.is_new_arrivals"
                  active-color="#13ce66"
                  inactive-color="#ff4949"
                >
                </el-switch>
                <div
                  v-if="form.errors.has('is_new_arrivals')"
                  class="el-form-item__error"
                  v-text="form.errors.first('is_new_arrivals')"
                ></div>
              </el-form-item>
              <single-media
                ...
                @single-file-selected="selectSingleFile($event, 'product')"
              ></single-media>
              <br />
              <multiple-media
                zone="slider_product"
    ...
    <button
      v-show="false"
      v-shortkey="['b']"
      @shortkey="pushRoute({ name: 'admin.page.product.index' })"
    ></button>
  </div>
</template>
<script>
